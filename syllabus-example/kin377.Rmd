...
I teach two different versions of this course (see below). The content covered is the same for both versions. The schedule varies slightly between the two versions. Refer to Canvas for more informaiton.  
