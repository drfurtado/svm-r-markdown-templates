...
This is a Fully Online Course (OF). A Fully Online Course is an online course offering in which all class sessions and exams are presented in an online environment. OF courses have no on-campus meetings. This course will be delivered 100% online via Canvas and taught ASYNCHRONOUSLY[^1]. This course consists of readings, written assignments, weekly responses, and check-ins on our Canvas page. 
...
Magill, R. A., & Anderson, D. (2020). Motor learning and control: Concepts and applications. McGraw-Hill Education. https://books.google.com/books?id=AgZTzQEACAAJ  
...
If you see mistakes or want to suggest changes, please create an issue on the [source repository](https://github.com/drfurtado/academic-templates/issues).