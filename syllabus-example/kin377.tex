...
This is a Fully Online Course (OF). A Fully Online Course is an online
course offering in which all class sessions and exams are presented in
an online environment. OF courses have no on-campus meetings. This
course will be delivered 100\% online via Canvas and taught
ASYNCHRONOUSLY\footnote{Lessons are pre-recorded and students go over
  the material on their own pace. However, assignments related to each
  module are due at the end of each week during the semester.}. This
course consists of readings, written assignments, weekly responses, and
...
\emph{Please, \textbf{stop} and read; this is important!}
...
Provide below are general information on each assignment. More detailed
