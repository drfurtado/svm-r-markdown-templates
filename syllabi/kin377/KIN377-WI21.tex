...
Office Hours: Tue 2 pm  &  Class Hours: Fully Online Assynchronous\\
...
Magill, R. A., \& Anderson, D. (2021). Motor learning and control:
Concepts and applications. McGraw-Hill Education.

Link to Matador Bookstore:
\url{https://www.bkstr.com/csunorthridgestore/search/keyword/Magill}
...
\item
  The student has sent me an email using the ``inbox'' feature of
  Canvas.
\end{enumerate}
...
\item
  ...
  first send an email to our class mailing list (see below), rather than
  sending me a personal email
  (\href{mailto:ovande.furtado@csun.edu}{\nolinkurl{ovande.furtado@csun.edu}}).
\item
