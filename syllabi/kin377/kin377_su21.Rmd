...
web: drfurtado.us
officehours: By Appt only - [see Email Policy below](#email-policy)
...
-   If you have questions concerning assignments, deadlines, etc., please first submit your question to our **course mailing list** (su21.kin377.1-c@csun.edu). For any other private matter related to this course, please send me an email directly.  
...
Plagiarism is a serious violation of the CSUN Student Conduct Code. Be aware that **borrowing** a paper from a student who completed this course previously (or is taking this course concurrently) and writing your paper based on that student's paper will be considered **PLAGIARISM**.
...
> Penalties: If caught, both students, the one who provided and the one who copied the work, will receive a letter grade of "F" on BOTH the Reflection Paper and the Video Performance assignments, in which case the student will likely fail the course as these two assignments account for 40% of the course total grade.
