...
6. If you choose to obtain your materials elsewhere you have until FRIDAY, **9/17/21** to Opt-Out (see instructions below). Those who Opt-Out by 9/17/21 will lose access and will **not be charged**.
7. Anyone who does not Opt-Out by the 9/17/21 deadline will be charged and those charges **will not be reversible**. 

#### Opt-out Instructions. 

If you wish to opt out of this program and not purchase access to the required digital materials you will need to follow the steps below by September 17, 2021: 
