...
Magill, R. A., & Anderson, D. (2021). Motor learning and control: Concepts and applications. McGraw-Hill Education.

Link to Matador Bookstore: <https://www.bkstr.com/csunorthridgestore/search/keyword/Magill>
...
5. The student has sent me an email using the "inbox" feature of Canvas.

More e-mail stuff...

-   If you have questions concerning assignments, deadlines, etc., please first send an email to our class mailing list (see below), rather than sending me a personal email (ovande.furtado@csun.edu).
